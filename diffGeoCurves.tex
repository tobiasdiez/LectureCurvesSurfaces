	...
	\section{Gauss map and shape operator}\label{Sec:Gauss map and shape operator}
        ...
        \section{Normal curvature}
            ...
            \begin{definition}[Principle curvatures]
                The maximum and minimum of the normal curvature $\kappa_p(u)$ as $u\in \TBundle_p S,\thinspace \norm{u} = 1$ are called principle curvatures of $p$, denoted by $\kappa_1$ and $\kappa_2$, the associated directions $u_1$ and $u_2$ are called the principle directions. Equivalently, by theorem of linear algebra, $\kappa_1(p)$ and $\kappa_2(p)$ are eigenvalues of $\mathcal{S}_p$ with eigenvectors $u_1$ and $u_2$. That is
                \begin{equation*}
                    \begin{aligned}
