...
\begin{document}
    ...
    \part{Surfaces}\label{Part:Surfaces}    
        \section{Definition and Construction of Surfaces}
            ...
            \end{definition}
            Intuitively, you can think of $S$ as a piece of rubber that is smoothly bent and stretched by the map $\Phi$, without creating any folds or creases (which would violate the injectivity or regularity conditions).
