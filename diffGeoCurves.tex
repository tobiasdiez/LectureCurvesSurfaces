    ...
    \part{Curves}\label{Part:Curves}
        \section{Parameterized curves}
            ...
            \begin{proof}
                ...
                \begin{equation*}
                    \begin{aligned}
                        L(c_2) &= \int_{a_2}^{b_2}\bigg|\bigg|\difFracAt{}{t}{t} c_2\bigg|\bigg|dt \\
                        &= \int_{a_2}^{b_2}\big|\varphi'(t)\big|\cdot\bigg|\bigg|\difFracAt{}{s}{\varphi(t)}c_1\bigg|\bigg|dt \\
                        &\stackrel{s=\varphi(t)}{=}\int_{a_1}^{b_1}\bigg|\bigg|\difFracAt{}{s}{s} c_1\bigg|\bigg|ds \\
                        &= L(c_1)
                    \end{aligned}
                \end{equation*}
            \end{proof}
